...
%%
%%
encode_compact_node_info_test_() ->
    {setup,
        fun() -> ok end,
        fun(_) -> ok end,
        [{"Encode node compact info.",
            fun() ->
                ?assertEqual(
                    ...
                    erline_dht_helper:encode_compact_node_info([
                        {{{65,12,45,225}, 8520}, <<169,246,141,183,17,96,15,191,158,252,221,69,218,231,8,97,231,8,214,41>>},
                        {{{12,34,92,156}, 1101}, <<169,246,141,183,17,96,15,191,158,252,221,69,218,231,8,97,231,8,214,43>>}
                    ])
                )
            end
        }]
        ...
        [{"Encode peer info.",
            fun() ->
                ?assertEqual(
                    ...
                    erline_dht_helper:encode_peer_info([
                        {{12,34,92,156}, 1101},
                        {{11,54,87,145}, 8237},
                        {{65,12,45,225}, 8520}
                    ])
