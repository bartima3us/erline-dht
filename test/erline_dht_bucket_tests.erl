...
handle_ping_response_test_() ->
    ...
    {setup,
        ...
        [{"Handle ping response. New hash is malformed.",
            fun() ->
                ?assertEqual(
                    #state{
                        event_mgr_pid = EventMgrPid,
                    ...
                    erline_dht_bucket:handle_ping_response({12,34,92,155}, 6862, <<"n3w_n0d3_h45h1">>, [{ping, <<0,2>>}], Bucket, State)
                ),
                ?assertEqual(
                    2,
                ...
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, notify, [EventMgrPid, {ping, r, {12,34,92,155}, 6862, <<"n3w_n0d3_h45h1">>}])
                ),
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, local_time, [])
        ...
        {"Handle ping response. Bucket is found. Distance is different from the old one. Bucket has some free space.",
            fun() ->
                ?assertEqual(
                    #state{
                        event_mgr_pid = EventMgrPid,
                    ...
                    erline_dht_bucket:handle_ping_response({12,34,92,155}, 6862, <<"n3w_n0d3_h45h3">>, [{ping, <<0,2>>}], Bucket, State)
                ),
                ?assertEqual(
                    2,
                ...
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, notify, [EventMgrPid, {ping, r, {12,34,92,155}, 6862, <<"n3w_n0d3_h45h3">>}])
                ),
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, local_time, [])
        ...
        {"Handle ping response. Bucket is found. Distance is different from the old one. Bucket has no free space.",
            fun() ->
                ?assertEqual(
                    #state{
                        event_mgr_pid = EventMgrPid,
                    ...
                    erline_dht_bucket:handle_ping_response({12,34,92,155}, 6862, <<"n3w_n0d3_h45h4">>, [{ping, <<0,2>>}], Bucket, State)
                ),
                ?assertEqual(
                    2,
                ...
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, notify, [EventMgrPid, {ping, r, {12,34,92,155}, 6862, <<"n3w_n0d3_h45h4">>}])
                ),
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, local_time, [])
        ...
        {"Handle ping response. Bucket is not found. Bucket has some free space.",
            fun() ->
                ?assertEqual(
                    #state{
                        event_mgr_pid = EventMgrPid,
                    ...
                    erline_dht_bucket:handle_ping_response({12,34,92,185}, 6882, <<"n3w_n0d3_h45h5">>, [{ping, <<0,2>>}], false, State)
                ),
                ?assertEqual(
                    2,
                ...
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, notify, [EventMgrPid, {ping, r, {12,34,92,185}, 6882, <<"n3w_n0d3_h45h5">>}])
                ),
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, local_time, [])
        ...
        {"Handle ping response. Bucket is not found. Bucket has no free space.",
            fun() ->
                ?assertEqual(
                    State,
                    erline_dht_bucket:handle_ping_response({12,34,92,186}, 6883, <<"n3w_n0d3_h45h6">>, [{ping, <<0,2>>}], false, State)
                ),
                ?assertEqual(
                    2,
                ...
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, notify, [EventMgrPid, {ping, r, {12,34,92,186}, 6883, <<"n3w_n0d3_h45h6">>}])
                ),
                ?assertEqual(
                    1,
                    meck:num_calls(erline_dht_helper, local_time, [])
